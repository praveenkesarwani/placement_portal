				...
				<div class="col-md-9">
					<div class="contact-form">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="number" class="form-control" id="contact" placeholder="College id" name="collid" required>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="number" max="100" class="form-control" id="xmarks" placeholder="marks" name="xmarks" required>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="number" max="100" class="form-control" id="xiimarks" placeholder="marks" name="xiimarks" required>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="gmarks" placeholder="marks" name="gmarks" required>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<textarea class="form-control" name='training' rows="5" id="training" required></textarea>
							</div>
						</div>
						<div class="form-group">
